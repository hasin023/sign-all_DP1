        ...
        <>
            ...
            <div className={`${poppins.className} min-h-screen bg-gray-100`}>
                ...
                <div className="bg-white p-8 shadow-lg rounded-lg max-w-2xl mx-auto my-12">
                    <h1 className="text-4xl font-extrabold text-gray-800 pb-6 text-center">Your Profile</h1>
                    {
                        !user ? (
                            ...
                            <form onSubmit={save} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className={`p-3 rounded-lg ${user.isVerified ? 'text-green-600 bg-green-100' : 'text-red-600 bg-red-100'}`}>
