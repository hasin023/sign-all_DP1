        ...
        <>
            ...
            <div className={`${poppins.className} min-h-screen bg-box`}>
                ...
                <div className="px-4">
                    ...
                    <button onClick={() => changeAlphabet('')} className="px-2 text-sm py-1 bg-red-500 rounded shadow-sm m-2 hover:bg-red-600">All</button>

                    {
    alphabets.map((alphabet, index) => (
        <button onClick={() => changeAlphabet(alphabet)} key={index + alphabet} className="px-2 text-sm py-1 bg-red-500 rounded shadow-sm m-2 hover:bg-red-600">{alphabet}</button>
    ))
}
