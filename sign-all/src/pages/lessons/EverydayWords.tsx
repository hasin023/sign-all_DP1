    ...
    const everydayWords = [
        {
            ...
            imageUrl: "/placeholder.svg?height=200&width=200&text=Yes",
        },
        {
            word: "No",
            description: "To express disagreement or negation",
            imageUrl: "/placeholder.svg?height=200&width=200&text=No",
        },
        {
            word: "Sorry",
            description: "To express regret or apologize",
            imageUrl: "/placeholder.svg?height=200&width=200&text=Sorry",
        },
        {
            word: "Help",
            description: "To request or offer assistance",
            imageUrl: "/placeholder.svg?height=200&width=200&text=Help",
        },
        {
            word: "Want",
            description: "To express desire for something",
            imageUrl: "/placeholder.svg?height=200&width=200&text=Want",
        },
        { word: "Need", description: "To express necessity", imageUrl: "/placeholder.svg?height=200&width=200&text=Need" },
        {
            word: "Like",
            description: "To express preference or enjoyment",
            imageUrl: "/placeholder.svg?height=200&width=200&text=Like",
        },
        {
            word: "Don't like",
            description: "To express dislike or aversion",
            imageUrl: "/placeholder.svg?height=200&width=200&text=Don't+like",
        },
    ]
